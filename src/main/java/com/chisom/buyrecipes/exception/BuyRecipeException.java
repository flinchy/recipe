...
@Getter
@ToString
public class BuyRecipeException extends RuntimeException {
    ...
    @Builder
    public BuyRecipeException(String message, String metadata, String infoLink, String errorCode, HttpStatus status) {
        super(message);
