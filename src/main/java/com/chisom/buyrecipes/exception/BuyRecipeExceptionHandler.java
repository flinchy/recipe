package com.chisom.buyrecipes.exception;

import com.chisom.buyrecipes.dto.ApiError;
...
public class BuyRecipeExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private String overrideWithBusinessMessageIfPresent(String originalMessage, Exception ex) {
        Throwable cause = ex.getCause();
        if (cause instanceof BuyRecipeException bre && isNotBlank(bre.getMessage())) {
